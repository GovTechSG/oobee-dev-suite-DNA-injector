/**
 * Oobee-Genome Client-Side Injector
 * 
 * This script injects data-oobee-* attributes into all DOM elements
 * for source location tracking during development.
 * 
 * Usage: Add <script src="oobee-injector.js"></script> to your HTML
 */
